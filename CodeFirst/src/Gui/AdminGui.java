...
public class AdminGui {
    ...
    public AdminGui(Login login) {
        ...
        getJShowAll().add(getAdmintable());
        getJShowAll().add(getMenuler());
        getJShowAll().add(getShowTable());
    ...
    public JPanel getJShowAll() {
        if (JShowAll == null) {
            JShowAll = new JPanel();
            JShowAll.setForeground(Color.WHITE);
            JShowAll.setBackground(new Color(0, 150, 136));
            JShowAll.setBorder(BorderFactory.createLineBorder(Color.yellow, 0));
            JShowAll.setLayout(null);

        }
        return JShowAll;
    }

    public void setJShowAll(JPanel JShowAll) {
        this.JShowAll = JShowAll;
    }
    ...
    public JTabbedPane getJtp() {
        if (jtp == null) {
            ...
            Icon iconMeeting1 = new ImageIcon("src/Images/networking.png");
            jtp.addTab("EKIP", iconMeeting1, getJShowAll(), "Ekip Islemleri");
            jtp.setFont(new Font("verdana", Font.BOLD, 24));
            jtp.setBorder(BorderFactory.createLineBorder(Color.yellow, 0));
            jtp.setCursor(cursorPointer);
    ...
    public JLabel getLabeluserName() {
        if (labeluserName == null) {
            ...
            labeluserName.setText("Yönetici Adı            : " + getLogin().getUser_text().getText());
    ...
    public JLabel getLabelEMail() {
        if (labelEMail == null) {
            ...
            labelEMail.setText("Yönetici EMail         : " + getLogin().getEmail_text().getText());
    ...
    public JLabel getLabelPassword() {
        if (labelPassword == null) {
            ...
            labelPassword.setText("Yönetici Şifre          : " + "' " + (String.valueOf(getLogin().getPass_text().getPassword())) + " '");
        ...
        if (labelSgkNo == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    labelSgkNo.setText("Yönetici SGKNO      :" + SGKNO);
                    labelChapter.setText("YöneticiBölüm       :" + DEPARTMAN);
                    labelPrice.setText("Yönetici Maaş        :" + MAAS);
                }
...
/////////////////////////////////// FONKSIYON BITIS ///////////////////////////////////////
    ...
    public JLabel getLabelChapter() {
        if (labelChapter == null) {
            ...
            labelChapter.setText("Yönetici Bölüm       :Yazılım Mühendisi");
    ...
    public JLabel getLabelPrice() {
        if (labelPrice == null) {
            ...
            labelPrice.setText("Yönetici Maaş        :10.000$ ");
    ...
    public JTable getAdmintable() {
        if (admintable == null) {
            ...
            admintable.setBounds(10, 50, 777, 200);
            admintable.setBackground(getJShowAll().getBackground());
            admintable.setForeground(getjProfil().getForeground());
            admintable.setFont(getjProfil().getFont());
            admintable.setBorder(BorderFactory.createLineBorder(Color.WHITE));
    ...
    public JLabel getMenuler() {
        if (menuler == null) {
            menuler = new JLabel();
            menuler.setBounds(10, 10, 777, 40);
            menuler.setBackground(getJShowAll().getBackground());
            menuler.setForeground(getjProfil().getForeground());
            menuler.setFont(getjProfil().getFont());
            menuler.setText("       ID                             ADSOYAD                             MAIL                                                 DEPARTMAN                     MAAS                          SGKNO");
        }
        return menuler;
    }

    public void setMenuler(JLabel menuler) {
        this.menuler = menuler;
    }

    public JButton getShowTable() {
        if (showTable == null) {
            showTable = new JButton();
            Icon iconShowTable = new ImageIcon("src/Images/menu.png");
            showTable.setIcon(iconShowTable);
            showTable.setBounds(375, 280, 70, 70);
            showTable.setOpaque(false);
            showTable.setBackground(getMenuler().getBackground());
            showTable.setFocusable(false);
            showTable.addActionListener(actions);
